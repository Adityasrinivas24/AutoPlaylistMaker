...
def get_playlist_id(playlist_url):
    ...
    if playlist_id:
        ...
        playlist_response = client.playlists().list(part='snippet',
...
playlist_id = "PLVDfFatHsysT6JHrHfmkFd_XSuzF4K_CQ"

keywords = ["18ec63", "18EC63"]

personal_playlist_id = "PLKyn_6NQ269xncCmHR4zCIg-eoEXMn1fk"

matching_videos = get_matching_videos(playlist_id, keywords)

add_videos_to_playlist(personal_playlist_id, matching_videos)


# # Function to add videos to a new playlist
# def add_videos_to_playlist(playlist_id, video_data):
#     youtube = build_youtube_client()
